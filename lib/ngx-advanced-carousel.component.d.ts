...
export declare class NgxAdvancedCarouselComponent implements ControlValueAccessor, AfterViewInit, OnDestroy {
    ...
    private set containerElmHeight(value);
    indexChanged: EventEmitter<any>;
    private _startIndex;
    private get startIndex();
    private set startIndex(value);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NgxAdvancedCarouselComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxAdvancedCarouselComponent, "ngx-advanced-carousel", never, { "data": "data"; "disableDrag": "disable-drag"; "infinite": "infinite"; "speed": "autoplay-speed"; "showNum": "show-num"; "autoplay": "autoplay"; "verticalModeEnabled": "verticalModeEnabled"; "startIndex": "startIndex"; "aniTime": "aniTime"; "aniClass": "aniClass"; "aniClassAuto": "aniClassAuto"; "showButtonsMethod": "show-next-prev-buttons"; "panBoundary": "pan-boundary"; "align": "align"; "notDrag": "not-follow-pan"; "trackByKey": "trackByKey"; "mourseEnable": "mourse-enable"; "delay": "between-delay"; "direction": "autoplay-direction"; "scrollNum": "scroll-num"; "isDragMany": "drag-many"; "swipeVelocity": "swipe-velocity"; "isRtl": "isRtl"; "breakpoint": "breakpoint"; "screenSizeMap": "screenSizeMap"; "padding": "padding"; }, { "indexChanged": "indexChanged"; "mappedData": "mappedData"; }, ["contentPrev", "contentNext", "dotElm", "carouselItemTemplate", "progressElm", "itemElms"], never, false, never>;
}
